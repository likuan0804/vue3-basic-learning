...
<script setup>
import { ref, getCurrentInstance, reactive, toRef, readonly, isProxy, watchEffect, toRaw, isReactive, shallowReactive } from 'vue'
...
// // readonly  递归只读
//  const 和readlyonly 的差别
//   const 复制保护，不能给这个变量进行赋值，readonly 不能给属性进行赋值
...
//     console.log('toRawvalue',toRaw(refFoo.value) === foo) // false
